...
authRoot
    ...
    .option(
        '-t, --target <env>',
        'The target environment for a new profile. Possible values are: local, preview, prod, or a custom URL.',
    )
    .option(
        '-r, --region <region>',
...
profilesRoot
    ...
    .option(
        '-t, --target <env>',
        'The target environment for the profile. Possible values are: local, preview, prod, or a custom URL.',
    )
    .option(
        '-r, --region <region>',
