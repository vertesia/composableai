...
const DEPRECATION_MESSAGE = "Warning: `vertesia worker` is deprecated and will be removed in a future release.";

function warnDeprecatedWorkerCommand() {
    console.warn(DEPRECATION_MESSAGE);
}

export function registerWorkerCommand(program: Command) {
    const worker = program.command("worker")
        .description("Build, release, and deploy custom workflow workers (deprecated)");
