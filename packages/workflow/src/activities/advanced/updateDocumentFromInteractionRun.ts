...
import type { DSLActivityExecutionPayload, DSLActivitySpec, ExecutionRun } from '@vertesia/common';
...
export async function updateDocumentFromInteractionRun(
    payload: DSLActivityExecutionPayload<UpdateDocumentFromInteractionRunParams>,
) {
