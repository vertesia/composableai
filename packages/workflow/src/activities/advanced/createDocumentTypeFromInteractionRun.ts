...
export interface CreateDocumentTypeFromInteractionRun
    extends DSLActivitySpec<CreateDocumentTypeFromInteractionRunParams> {
...
export async function createDocumentTypeFromInteractionRun(
    payload: DSLActivityExecutionPayload<CreateDocumentTypeFromInteractionRunParams>,
) {
