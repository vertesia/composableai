...
export async function convertPdfToStructuredText(
    payload: DSLActivityExecutionPayload<ConvertPdfToStructuredTextParams>,
...
export async function getS3AWSCredentials(
    awsConfig: AwsConfiguration,
    composableAuthToken: string,
    projectId: string,
    ...
    log.info('Getting AWS credentials for Textract', {
        projectId,
        composableAuthToken,
