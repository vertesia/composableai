...
export const RenditionSchema: JSONSchemaType<RenditionProperties> = {
    type: 'object',
    description:
        'Represent a rendition of a file stored in an object. It will be stored as a separate object in the database.',
    properties: {
        mime_type: {
            type: 'string',
...
export const DocumentPartSchema: JSONSchemaType<DocumentPartProperties> = {
    ...
    properties: {
        ...
        description: {
            type: 'string',
            description:
                "The description of the document part, if it's an image, the exhaustive description of the image",
            nullable: true,
        },
        height: {
            type: 'integer',
