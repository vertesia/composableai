...
import {
    ...
    BatchDispatchResultArraySchema,
    BatchDispatchResultSchema,
    BatchFlushReasonSchema,
    BatchPollResultArraySchema,
    BatchPollResultSchema,
    BatchPoolInfoArraySchema,
    BatchPoolInfoSchema,
    ...
    InCodePromptSchema,
    InferenceBatchArraySchema,
    InferenceBatchSchema,
    InferenceBatchStatusSchema,
...
const EXECUTION_RUN_SCHEMAS = {
    ...
    InferenceBatchStatus: InferenceBatchStatusSchema,
    InferenceBatch: InferenceBatchSchema,
    InferenceBatchArray: InferenceBatchArraySchema,
    BatchPoolInfo: BatchPoolInfoSchema,
    BatchPoolInfoArray: BatchPoolInfoArraySchema,
    BatchFlushReason: BatchFlushReasonSchema,
    BatchDispatchResult: BatchDispatchResultSchema,
    BatchDispatchResultArray: BatchDispatchResultArraySchema,
    BatchPollResult: BatchPollResultSchema,
    BatchPollResultArray: BatchPollResultArraySchema,
    ListInferenceBatchesQuery: ListInferenceBatchesQuerySchema,
    BatchReconcileRequest: BatchReconcileRequestSchema,
    BatchReconcileResponse: BatchReconcileResponseSchema,
