...
const MEMORY_SCHEMAS = {
    ...
    MemoryContentSourceSelector: MemoryContentSourceSelectorSchema,
    MemoryAgentRunSourceSelector: MemoryAgentRunSourceSelectorSchema,
    MemorySourceSelector: MemorySourceSelectorSchema,
    MemoryBrainRecipe: MemoryBrainRecipeSchema,
    MemoryBrainUpdatePolicy: MemoryBrainUpdatePolicySchema,
    MemoryBrainLaneState: MemoryBrainLaneStateSchema,
    MemoryBrain: MemoryBrainSchema,
    MemoryBrainArray: MemoryBrainArraySchema,
    CreateMemoryBrainPayload: CreateMemoryBrainPayloadSchema,
    UpdateMemoryBrainPayload: UpdateMemoryBrainPayloadSchema,
    PromoteMemoryGenerationPayload: PromoteMemoryGenerationPayloadSchema,
    MemoryBrainActionResponse: MemoryBrainActionResponseSchema,
    MemoryGenerationCounts: MemoryGenerationCountsSchema,
    MemoryGeneration: MemoryGenerationSchema,
    MemoryGenerationArray: MemoryGenerationArraySchema,
    MemoryRunCounts: MemoryRunCountsSchema,
    MemoryRunSummary: MemoryRunSummarySchema,
    MemoryRunSummaryArray: MemoryRunSummaryArraySchema,
    MemoryEvidenceLocator: MemoryEvidenceLocatorSchema,
    MemoryEvidenceRef: MemoryEvidenceRefSchema,
    MemoryEvidenceRefArray: MemoryEvidenceRefArraySchema,
    MemoryEvidenceEntry: MemoryEvidenceEntrySchema,
    MemoryFacetCount: MemoryFacetCountSchema,
    MemoryNodeEvidenceQuery: MemoryNodeEvidenceQuerySchema,
    MemoryNodeEvidenceRow: MemoryNodeEvidenceRowSchema,
    MemoryNodeEvidenceFacets: MemoryNodeEvidenceFacetsSchema,
    MemoryNodeEvidenceResponse: MemoryNodeEvidenceResponseSchema,
    MemorySupport: MemorySupportSchema,
    MemoryNode: MemoryNodeSchema,
    MemoryNodeArray: MemoryNodeArraySchema,
    MemoryStatementNodeObject: MemoryStatementNodeObjectSchema,
    MemoryStatementLiteralObject: MemoryStatementLiteralObjectSchema,
    MemoryStatementObject: MemoryStatementObjectSchema,
    MemoryStatement: MemoryStatementSchema,
    MemoryStatementArray: MemoryStatementArraySchema,
    MemoryNodePattern: MemoryNodePatternSchema,
    MemoryStatementPatternObject: MemoryStatementPatternObjectSchema,
    MemoryStatementPatternBody: MemoryStatementPatternBodySchema,
    MemoryStatementPattern: MemoryStatementPatternSchema,
    MemoryGraphPattern: MemoryGraphPatternSchema,
    MemoryValueFilter: MemoryValueFilterSchema,
    MemoryPathQuery: MemoryPathQuerySchema,
    MemoryGraphQuery: MemoryGraphQuerySchema,
    MemoryPath: MemoryPathSchema,
    MemoryGraphQueryResult: MemoryGraphQueryResultSchema,
    MemoryOntologyNodeType: MemoryOntologyNodeTypeSchema,
    MemoryPredicateNodeObject: MemoryPredicateNodeObjectSchema,
    MemoryPredicateLiteralObject: MemoryPredicateLiteralObjectSchema,
    MemoryPredicateObjectSignature: MemoryPredicateObjectSignatureSchema,
    MemoryOntologyPredicate: MemoryOntologyPredicateSchema,
    MemoryOntology: MemoryOntologySchema,
    MemoryOntologyArray: MemoryOntologyArraySchema,
    CreateMemoryOntologyPayload: CreateMemoryOntologyPayloadSchema,
    MemoryRunSourceRef: MemoryRunSourceRefSchema,
    CreateMemoryRunPayload: CreateMemoryRunPayloadSchema,
    MemoryNodeHandle: MemoryNodeHandleSchema,
    MemoryStatementHandle: MemoryStatementHandleSchema,
    MemoryWitnessRef: MemoryWitnessRefSchema,
    MemoryStatementObjectRefNode: MemoryStatementObjectRefNodeSchema,
    MemoryStatementObjectRefLiteral: MemoryStatementObjectRefLiteralSchema,
    MemoryStatementObjectRef: MemoryStatementObjectRefSchema,
    MemoryPutNodeOp: MemoryPutNodeOpSchema,
    MemoryAddStatementOp: MemoryAddStatementOpSchema,
    MemoryLinkEvidenceOp: MemoryLinkEvidenceOpSchema,
    MemoryRetractNodeOp: MemoryRetractNodeOpSchema,
    MemoryRetractStatementOp: MemoryRetractStatementOpSchema,
    MemoryRunOperation: MemoryRunOperationSchema,
    MemoryStageOpsPayload: MemoryStageOpsPayloadSchema,
    MemoryRefusal: MemoryRefusalSchema,
    MemoryStagedNode: MemoryStagedNodeSchema,
    MemoryStagedOp: MemoryStagedOpSchema,
    ...
    MemoryReadGraphPayload: MemoryReadGraphPayloadSchema,
    MemoryQueryPayload: MemoryQueryPayloadSchema,
    MemoryContextPackBrainRef: MemoryContextPackBrainRefSchema,
    MemoryEvidenceExcerpt: MemoryEvidenceExcerptSchema,
    MemoryContextPackWarning: MemoryContextPackWarningSchema,
    MemoryContextPackRetrieval: MemoryContextPackRetrievalSchema,
    MemoryContextPack: MemoryContextPackSchema,
    MemoryProjectionStatus: MemoryProjectionStatusSchema,
    MemoryProjectionRebuildResponse: MemoryProjectionRebuildResponseSchema,
} as const satisfies Record<string, z.ZodType>;
...
const STRICT_COMPONENTS: ReadonlySet<string> = new Set<string>([
    ...
    // Canonical Memory store. Every component is closed: a Brain configuration, a graph query and a
    // graph projection are all fixed vocabularies, and an undeclared property in any of them is a
    // caller mistake worth reporting rather than silently dropping.
    'MemoryContentSourceSelector',
    'MemoryAgentRunSourceSelector',
    'MemoryBrainRecipe',
    'MemoryBrainUpdatePolicy',
    'MemoryBrainLaneState',
    'MemoryBrain',
    'CreateMemoryBrainPayload',
    'UpdateMemoryBrainPayload',
    'PromoteMemoryGenerationPayload',
    'MemoryBrainActionResponse',
    'MemoryGenerationCounts',
    'MemoryGeneration',
    'MemoryRunCounts',
    'MemoryRunSummary',
    'MemoryEvidenceLocator',
    'MemoryEvidenceRef',
    'MemoryEvidenceEntry',
    'MemoryFacetCount',
    'MemoryNodeEvidenceQuery',
    'MemoryNodeEvidenceRow',
    'MemoryNodeEvidenceFacets',
    'MemoryNodeEvidenceResponse',
    'MemorySupport',
    'MemoryNode',
    'MemoryStatementNodeObject',
    'MemoryStatementLiteralObject',
    'MemoryStatement',
    'MemoryNodePattern',
    'MemoryStatementPatternObject',
    'MemoryStatementPatternBody',
    'MemoryStatementPattern',
    'MemoryValueFilter',
    'MemoryPathQuery',
    'MemoryGraphQuery',
    'MemoryPath',
    'MemoryGraphQueryResult',
    // The build side: the vocabulary a run authors against, and the operations it stages. Closed for
    // the same reason and one more — a mistyped key in a model-authored operation must surface as a
    // refusal the run can correct, not as a field that silently never arrives.
    'MemoryOntologyNodeType',
    'MemoryPredicateNodeObject',
    'MemoryPredicateLiteralObject',
    'MemoryOntologyPredicate',
    'MemoryOntology',
    ...
    'MemoryWitnessRef',
    'MemoryStatementObjectRefNode',
    'MemoryStatementObjectRefLiteral',
    'MemoryPutNodeOp',
    'MemoryAddStatementOp',
    'MemoryLinkEvidenceOp',
    'MemoryRetractNodeOp',
    'MemoryRetractStatementOp',
    ...
    // Natural-language query and its Context Pack. Closed for the same reason as the graph query:
    // an unrecognized field in a retrieval request is a caller mistake, not an extension point.
    'MemoryQueryPayload',
    'MemoryContextPackBrainRef',
    'MemoryEvidenceExcerpt',
    'MemoryContextPackRetrieval',
    'MemoryContextPack',
