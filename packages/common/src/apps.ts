...
// ============================================================================
// MCP Skill Generation Types
// ============================================================================

/**
 * A logical skill group generated by the MCP skill generation agent.
 * Each group clusters related MCP tools under a single learn_* skill
 * that can be loaded on demand by the agent.
 */
export interface MCPSkillGroup {
    /** snake_case endpoint name (e.g. "issue_management") — server prepends learn_ */
    name: string;
    /** Human-readable title (e.g. "Issue Management") */
    title: string;
    /** One-sentence description of the skill's purpose */
    description: string;
    /** Instructions injected into the agent's context when this skill is learned */
    instructions: string;
    /** Exact namespaced tool names from the MCP server unlocked by this skill */
    tool_names: string[];
}
