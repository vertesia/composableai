...
describe('Builder', () => {
    ...
    test('create memory pack override', async () => {
        ...
        expect(entries.map((e) => e.name).sort()).toStrictEqual(
            ['file2.txt', 'file3.txt', 'file4.txt', MEMORY_METADATA_ENTRY].sort(),
        );
    ...
    test('MemoryPack.exportObject', async () => {
        ...
        expect(obj).toStrictEqual({
            content: ['file2 from new memory', 'file3 from base memory', 'file4 from new memory'],
        });
        ...
        expect(obj).toStrictEqual({
            content: ['file2 from new memory', 'file3 from base memory'],
        });
        ...
        expect(obj).toStrictEqual({
            content: ['file2 from new memory', 'file4 from new memory'],
        });
