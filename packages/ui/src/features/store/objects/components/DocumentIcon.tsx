...
export function DocumentIcon({
    ...
    return (
        ...
        >
            ...
            {selection && (
                <div className="absolute top-2 start-2 z-10 flex flex-col items-center gap-1">
                    <input
            ...
            <div className="absolute top-1 end-1 z-10 flex flex-col items-center">
                <Button
                    variant="ghost"
                    size="sm"
