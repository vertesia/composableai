        ...
        <div className="flex flex-col space-y-6 overflow-y-auto py-4">
            ...
            {messages.length === 0 && !isCompleted && (
                <div className="flex items-center justify-center flex-1 text-center py-8">
                    <div className="flex items-center gap-3 bg-info rounded-lg border border-info px-4 py-3">
                        <div className="text-sm text-info font-medium">{ThinkingMessages[thinkingMessageIndex]}</div>
                    </div>
                </div>
            )}
        </div>
