        ...
        <div className="h-full overflow-hidden">
            <div className="p-3 overflow-y-auto h-full">
                ...
                <div className="mb-3 p-2 bg-info rounded-md border border-info">
                    <div className="text-xs font-medium text-info mb-1">{t('agent.taskProgress')}</div>
                    ...
                    <div className="mb-3 flex items-center justify-between">
                        ...
                        <div className="text-xs text-muted">
                            {plans[activePlanIndex]?.timestamp
                                ? new Date(plans[activePlanIndex].timestamp).toLocaleTimeString()
                                : t('agent.unknownTime')}
                        </div>
                        <Button
                            variant={'ghost'}
                            ...
                            <div className="p-3">
                                <div className="grid grid-cols-1 gap-2">
                                    {workstreamEntries.map(([id, status]) => {
                                        ...
                                        return (
                                            <div key={id} className={cn('flex items-center p-1.5 rounded', statusBg)}>
