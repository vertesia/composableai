...
const TOOL_SERVER_RESOURCE_REFERENCE_PATH = join(PACKAGE_ROOT, 'references', 'tool-server-resource.md');
    ...
    if (!content || content.trim().length === 0) {
        throw new Error(
            `generate-docs: tool-server resource reference not found or empty at ${TOOL_SERVER_RESOURCE_REFERENCE_PATH}. ` +
                'The appgen docs package must include its canonical references directory.',
        );
    }
    return `<!-- Generated by @vertesia/appgen-docs from
references/tool-server-resource.md. Do not edit the generated file. -->
