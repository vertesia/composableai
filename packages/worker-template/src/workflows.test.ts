...
import { exampleWorkflow, inspectObjectsWorkflow, type ExampleWorkflowResult } from './workflows.js';
    ...
    describe('exampleWorkflow', () => {
        it('successfully processes multiple objects', async () => {
            ...
            const activities = {
                ...
                ): Promise<ProcessObjectResult> => Promise.resolve(mockResults[payload.params.objectId]),
                getObjectMetadataActivity: (
                    _payload: ActivityExecutionPayload<ProcessObjectParams>
                ): Promise<ObjectMetadata> => Promise.resolve({ objectId: '', name: '', properties: {} }),
            };
        ...
        it('handles empty objectIds array', async () => {
            ...
            const activities = {
                processObjectActivity: (
                    _payload: ActivityExecutionPayload<ProcessObjectParams>
                ): Promise<ProcessObjectResult> => Promise.resolve({ objectId: '', name: '', success: true }),
                getObjectMetadataActivity: (
                    _payload: ActivityExecutionPayload<ProcessObjectParams>
                ): Promise<ObjectMetadata> => Promise.resolve({ objectId: '', name: '', properties: {} }),
            };
    ...
    describe('inspectObjectsWorkflow', () => {
        it('successfully retrieves metadata for multiple objects', async () => {
            ...
            const activities = {
                ...
                getObjectMetadataActivity: (
                    payload: ActivityExecutionPayload<ProcessObjectParams>
                ): Promise<ObjectMetadata> => Promise.resolve(mockMetadata[payload.params.objectId]),
            };
